        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title m-0 h5">Add Channel</h3>
                </div>
                <div class="card-body">

                  
                    <form action="{{ route('channel.store') }}" class="form form-horizontal create-form" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <textarea name="channel_description" id="channel_description" class="form-control editor" rows="10"></textarea>
                        </div>
