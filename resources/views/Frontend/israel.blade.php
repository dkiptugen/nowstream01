...
<section class="hero-section hero-3 position-relative">
    ...
    <div class="bottom text-center border-light py-2">Buy Israel Mbonyi Live Access <a
            class="btn btn-link px-1 py-1 text-warning" href="#">Here</a> OR Get <b>2GB</b> Bundles
        Plus
...
<section id="merchandise"
    ...
    <div class="container">
        <div class="row gy-4 gy-lg-0 align-items-lg-end justify-content-lg-between mb-40 mb-lg-70">
            <div class="col-lg-4">
                <div class="section-title wow fadeInRight"><span
                        class="fs-3 straight-line-wrapper fw-semibold position-relative "> <span
                            class="straight-line"></span>The Shop</span>
                    <h2 class="title display-3 fw-extra-bold d-flex flex-column"><span class="mb-n2 text-opacity ">
                            <span><span style="opacity: 1;">Get
                                    <!-- -->
                                </span><span style="opacity: 1;">Our
                                    <!-- -->
                                </span></span></span><span
                            class="sub-title fw-extra-bold  text-primary">Merchandise</span></h2>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="highlights-text wow fadeInLeft">
                    <p class="mb-0 custom-jakarta custom-font-style-2 mb-2 text-lg-end">Elevating the Music. Our valued
                        partners and sponsors play a pivotal role in bringing our vision to life. With their support, we
                        orchestrate an unforgettable music celebration.</p>
                </div>
            </div>
        </div>
        <div class="merchandise-contents position-relative">
            <div class="ellipse-image-4"><img alt="img" loading="lazy" width="126" height="262" decoding="async"
                    data-nimg="1" class="img-fluid" style="color:transparent"
                    src="{{asset('israel-assets/images/ellipse-4.png')}}"></div>
            <div class="swiper swiper-initialized swiper-horizontal merchandise-swiper py-20 swiper-backface-hidden">
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper-slide-active">
                        <div class="merchandise-wrapper">
                            <div class="merchandise-image mb-4"><img alt="img" loading="lazy" width="270" height="250"
                                    decoding="async" data-nimg="1" style="color:transparent"
                                    src="{{asset('israel-assets/images/important/yellow.png')}}"></div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="product-information">
                                    <h5>Yellow Hoodie...</h5>
                                    <h6 class="text-primary fw-bold">KES
                                        <!-- -->2,499
                                    </h6>
                                </div>
                                <div><a href="#" class="btn btn-outline-primary btn-custom-dark"
                                        aria-label="buttons">Buy Now</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide swiper-slide-next">
                        <div class="merchandise-wrapper">
                            <div class="merchandise-image mb-4"><img alt="img" loading="lazy" width="270" height="250"
                                    decoding="async" data-nimg="1" style="color:transparent"
                                    src="{{asset('israel-assets/images/important/white.png')}}"></div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="product-information">
                                    <h5>White Hoodie</h5>
                                    <h6 class="text-primary fw-bold">KES
                    ...
                    <div class="swiper-slide">
                        <div class="merchandise-wrapper">
                            <div class="merchandise-image mb-4"><img alt="img" loading="lazy" width="270" height="250"
                                    decoding="async" data-nimg="1" style="color:transparent"
                                    src="{{asset('israel-assets/images/important/purple.png')}}"></div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="product-information">
                                    <h5>Black T-Sh...</h5>
                                    <h6 class="text-primary fw-bold">KES
                    ...
                    <div class="swiper-slide">
                        <div class="merchandise-wrapper">
                            <div class="merchandise-image mb-4"><img alt="img" loading="lazy" width="270" height="250"
                                    decoding="async" data-nimg="1" style="color:transparent"
                                    src="{{asset('israel-assets/images/important/yellowt.png')}}"></div>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="product-information">
                                    <h5>Yellow T-Sh...</h5>
                                    <h6 class="text-primary fw-bold">KES
        ...
        <div class="container">
            <div class="row gy-20 gy-lg-0 align-items-lg-center justify-content-lg-between">
                <div class="col-lg-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2
                            class="fs-180-style-2 fw-bold  text-primary custom-jakarta number_gap d-flex align-items-center gap-2 mb-0">
                            <span class="index-module_slot_wrap__ZT-DX"><span class="index-module_slot__DpPgW"
                                    style="display: inline-block; height: 180px;"><span
                                        class="index-module_numbers__sqlqm">30</span></span></span></span><span
                                class="d-flex flex-column cta-percent-off"><span
                                    class="cta-percent fw-extra-bold">%</span><span
                                    class="cta-off fw-extra-bold">Off</span></span></h2>
                        <div class="d-block d-lg-none">
                            <div class="cta-icon"><a aria-label="icons" href="#ticket"><span
                                        class="arrow-up-right-big undefined"><svg width="205" height="205">
                                            <use xlink:href="#arrow-up-right-big">
                ...
                <div class="col-lg-5">
                    <h2 class="cta-text ms-xl-n60 display-3 fw-extra-bold custom-sans-serif"><span><span
                                style="opacity: 1;">Get
                                <!-- -->
                            </span><span style="opacity: 1;">Your
                                <!-- -->
                            </span><span style="opacity: 1;">Tickets
                                <!-- -->
                            </span><span style="opacity: 1;">Today!
                                <!-- -->
                            </span></span></h2>
                </div>
                <div class="col-lg-3">
                    <div class="cta-icon d-none d-lg-block ms-xl-70 ms-xxl-100"><a aria-label="icons"
                            href="#ticket"><span class="arrow-up-right-big arrow-secondary"><svg width="205"
                                    height="205">
                                    <use xlink:href="#arrow-up-right-big">
                                        <symbol id="arrow-up-right-big" viewBox="0 0 218 218">
                                            <path
