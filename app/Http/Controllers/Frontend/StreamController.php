        ...
        public function proxyStream(string $streamId)
            {
                ...
                try
                    ...
                    {
                        Content::find($streamId)->update(['status' => 2]);
                ...
                try
                    {
                        ...
                        $channels = Cache::remember('channels_top_8', now()->addDay(), fn() => Channel::where('status', 1)->take(8)->get()
                        );

                        $videos = Cache::remember('videos_top_12', now()->addDay(), fn() => Content::where('type', 'video')->take(12)->get()
                        );
