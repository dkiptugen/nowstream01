...
class StreamKeyNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Your stream token is: ' . $this->subscription->stream_token . '. Click https://streamer.co.ke/somalinite and use the streaming key')
            ->line('to access and watch the Event.')
            ->line('How to use your Streaming Key:')
            ->line('1. Navigate to the Somali Nite homepage https://streamer.co.ke/somalinite')
