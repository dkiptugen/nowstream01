    ...
    class Mpesa
        {
            ...
            public  $qrformat;
            public  $qrtype;
            public  $email = 'digital.developer@ke.radioafricagroup.co.ke';
            public  $logo  = '';
            public  $items;
            public  $invoice_no;
            public  $name;
         ...
         * @return object|array
         */
            public function stkpush(): string | object | array
                {
                    try
                        {
                            ...
                            $data      = [
                                ...
                                'PartyA'            => $this->msisdn,
                                'PartyB'            => $shortcode,
                                'PhoneNumber'       => $this->msisdnFormatter($this->msisdn),
                                'CallBackURL'       => $this->stk_callback,
	                        ...
	                        //dd($token);
                            return $this->invoke_server($this->link . config('mpesa.checkout_processlink'), $data, trim($token));
                    ...
                    try
                        {
                            ...
                            return $this->invoke_server($this->link . config('mpesa.checkout_querylink'), $data, $this->generate_token());
                        }
                    catch (HttpException $e)
                        {
                            Log::error($e->getMessage());
